...
Lower than T1 (0.97) because of the spring → ease translation. GSAP's `back.out(1.4)` is
visually similar to Remotion's default spring but the late-tail curvature differs slightly,
costing ~0.04–0.05 mean SSIM. If the translation breaks anything else, mean SSIM will fall
well below 0.92 — that's the failure signal.
